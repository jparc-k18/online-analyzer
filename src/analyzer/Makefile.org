...
core_obj = EMCParamMan.o UserParamMan.o HodoParamMan.o HodoPHCMan.o DCGeomMan.o DCTdcCalibMan.o DCDriftParamMan.o DCGeomRecord.o ConfMan.o 
...
#	$(my_old_tgt)
 ...
 $(my_dir)/dict/MatrixParamMan_Dict.cc: \
 $(my_dir)/include/MatrixParamMan.hh \
 $(my_dir)/linkdef/MatrixParamMan_LinkDef.hh
	$(QUIET) $(ECHO) "=== Generating dictionary $^ - > $@"
	rootcint -f $@ -c -p $^

 $(my_dir)/dict/MsTParamMan_Dict.cc: \
 $(my_dir)/include/MsTParamMan.hh \
 $(my_dir)/linkdef/MsTParamMan_LinkDef.hh
	$(QUIET) $(ECHO) "=== Generating dictionary $^ - > $@"
	rootcint -f $@ -c -p $^

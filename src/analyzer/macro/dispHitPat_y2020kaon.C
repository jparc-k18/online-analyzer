...

{
  ...
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+1);
  h->SetMinimum(0);
  h->Draw();
  ...
  //h = (TH1*)GHist::get(base_id);
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+2);
  h->SetMinimum(0);
  h->Draw();
  ...
  //h = (TH1*)GHist::get(base_id);
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+3);
  h->SetMinimum(0);
  h->Draw();
  ...
  //h = (TH1*)GHist::get(base_id);
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+4);
  h->SetMinimum(0);
  h->Draw();
  ...
  //h = (TH1*)GHist::get(base_id);
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+5);
  h->SetMinimum(0);
  h->Draw();
  ...
  //h = (TH1*)GHist::get(base_id);
  h = (TH1*)GHist::get(HistMaker::getUniqueID(kMisc, 0, kTDC)+30+16+6);
  h->SetMinimum(0);
  h->Draw();
  c->Update();

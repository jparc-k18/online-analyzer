...
void effFHT( void )
{
  ...
  // draw Multi with plane efficiency FHT
  {
    ...
    Int_t base_id[n_layer] = {
      ...
      HistMaker::getUniqueID(kFHT1, 0, kMulti, 201),
      HistMaker::getUniqueID(kFHT1, 1, kMulti, 1),
      HistMaker::getUniqueID(kFHT1, 1, kMulti, 201),
      HistMaker::getUniqueID(kFHT2, 0, kMulti, 1),
      HistMaker::getUniqueID(kFHT2, 0, kMulti, 201),
      HistMaker::getUniqueID(kFHT2, 1, kMulti, 1),
      HistMaker::getUniqueID(kFHT2, 1, kMulti, 201)
    };

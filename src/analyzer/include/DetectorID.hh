...
const Int_t DetIdE75LFBAC      = 76; // E75BAC during 2025Nov E63beamtime
const Int_t NumOfSegBH1     = 11;
const Int_t NumOfSegBH2     =  8;
const Int_t NumOfSegBAC     =  2;
const Int_t NumOfSegE75BAC     =  2; // E75 BAC test during E63 beatime
const Int_t NumOfSegE75LFBAC     =  1; // E75 BAC test during E63 beatime

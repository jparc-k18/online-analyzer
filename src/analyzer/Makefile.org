...
my_obj_event_display	:= $(core_obj) user_event_display.o $(gui_obj)
...
my_obj_event_display	:= $(my_obj_event_display) \
...
$(eval $(call make-gui-target,$(my_tgt_event_display),$(my_lib_event_display)))

...
process_begin( const std::vector<std::string>& argv )
{
  ...
  // please do not use a white space character.
  {
    ...
    gScaler.Set( c, r++, ScalerInfo( "LAC-01",     1, 32 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-02",     1, 33 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-03",     1, 47 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-04",     1, 35 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-05",     1, 36 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-06",     1, 37 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-07",     1, 38 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-08",     1, 39 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-09",     1, 40 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-10",     1, 41 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-11",     1, 42 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-12",     1, 43 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-13",     1, 44 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-14",     1, 45 ) );
    gScaler.Set( c, r++, ScalerInfo( "LAC-15",     1, 46 ) );

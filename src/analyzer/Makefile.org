...
core_obj = UserParamMan.o HodoParamMan.o HodoPHCMan.o DCGeomMan.o DCTdcCalibMan.o DCDriftParamMan.o DCGeomRecord.o ConfMan.o ProcInfo.o
#core_obj = SsdAnalyzer.o EMCParamMan.o UserParamMan.o HodoParamMan.o HodoPHCMan.o DCGeomMan.o DCTdcCalibMan.o DCDriftParamMan.o DCGeomRecord.o ConfMan.o ProcInfo.o
...
my_obj_rawhist_e13	:= $(core_obj) user_rawhist_e13.o HistMaker.o GuiPs.o PsMaker.o MacroBuilder.o GeAdcCalibMan.o
...
my_obj_rawhist_e07	:= $(core_obj) user_rawhist_e07.o HistMaker.o GuiPs.o PsMaker.o MacroBuilder.o MsTParamMan.o MatrixParamMan.o
my_tgt_rawhist_e07	:= $(bin_dir)/raw_hist_e07

my_obj_rawhist_e40	:= $(core_obj) user_rawhist_e40.o HistMaker.o GuiPs.o PsMaker.o MacroBuilder.o MsTParamMan.o MatrixParamMan.o
my_tgt_rawhist_e40	:= $(bin_dir)/raw_hist_e40

my_obj_rawhist_catch	:= $(core_obj) user_rawhist_catch.o HistMaker.o GuiPs.o PsMaker.o MacroBuilder.o MsTParamMan.o MatrixParamMan.o
my_tgt_rawhist_catch	:= $(bin_dir)/raw_hist_catch

my_obj_rawhist_vmeeasiroc	:= $(core_obj) user_rawhist_vmeeasiroc.o HistMaker.o GuiPs.o PsMaker.o MacroBuilder.o MsTParamMan.o MatrixParamMan.o
my_tgt_rawhist_vmeeasiroc	:= $(bin_dir)/raw_hist_vmeeasiroc

my_obj_http_server	:= $(core_obj) user_http_server.o HistMaker.o HttpServer.o MacroBuilder.o MsTParamMan.o MatrixParamMan.o
my_tgt_http_server	:= $(bin_dir)/http_server

my_obj_emc_position	:= $(core_obj) user_emc_position.o HistMaker.o
...
my_obj_beamprofile_e03  := $(core_obj) user_beamprofile_e03.o HistMaker.o MacroBuilder.o DCAnalyzer.o
my_tgt_beamprofile_e03  := $(bin_dir)/beamprofile_e03

my_obj_beamprofile_e40  := $(core_obj) user_beamprofile_e40.o HistMaker.o MacroBuilder.o DCAnalyzer.o
...
my_obj_scaler_e40	:= $(core_obj) user_scaler_e40.o ScalerAnalyzer.o
...
my_obj_rawhist_e07	:= $(my_obj_rawhist_e07) \
		$(my_dir)/dict/HistMaker_Dict.o \
		$(my_dir)/dict/GuiPs_Dict.o \
		$(my_dir)/dict/MatrixParamMan_Dict.o \
		$(my_dir)/dict/MsTParamMan_Dict.o

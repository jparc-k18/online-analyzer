...
process_begin( const std::vector<std::string>& argv )
{
  ...
  // b->SetMainTransparency( 63 );
  // b->SetVertex( 0, -10, -10, -10 );
  // b->SetVertex( 1, -10,  10, -10 );
  // b->SetVertex( 2,  10,  10, -10 );
  // b->SetVertex( 3,  10, -10, -10 );
  // b->SetVertex( 4, -10, -10,  10 );
  // b->SetVertex( 5, -10,  10,  10 );
  // b->SetVertex( 6,  10,  10,  10 );
  // b->SetVertex( 7,  10, -10,  10 );
  // gEve->AddElement(b);
  // gEve->Redraw3D( kTRUE );

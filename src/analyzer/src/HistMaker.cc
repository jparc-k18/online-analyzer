...
{
  // Determine the detector name
  TString strDet = CONV_STRING(kTC);
  // name list of crearted detector
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    // name list which are displayed in Ps tab
  ...
  // TDC-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kTDC2D  , 0);
    const char* sub_name = "TDC";
    // Add to the top directory
  ...
  // TOT-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kTOT2D  , 0);
    const char* sub_name = "TOT";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
  ...
  // ADC-2D HighGain ----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kHighGain, 10);
    const char* sub_name = "HG";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
    ...
    // ADC-2D HighGain Cut ------------------------------------------
    target_id = getUniqueID(kTC, 0, kHighGain, 100);
    sub_name = "CHG";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
  ...
  // ADC-2D LowGain -----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kLowGain, 10);
    const char* sub_name = "LG";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
    ...
    // ADC-2D LowGain Cut ------------------------------------------
    target_id = getUniqueID(kTC, 0, kLowGain, 100);
    sub_name = "CLG";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
  ...
  // MultiHitTdc-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kMultiHitTdc, 20);
    const char* sub_name = "MultiHitTdc";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
  ...
  // ADC HighGain vs TOT ----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kHighGainvsTOT, 30);
    const char* sub_name = "HGvsTOT";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      TString strSubSubDir  = Form("%s%d_%s", nameDetector, i, sub_name);
      const char* nameSubSubDir = strSubSubDir.Data();
      TList *sub_sub_dir = new TList;
      sub_sub_dir->SetName(nameSubSubDir);
      for(Int_t j=0; j<NumOfSegVMEEASIROC; ++j){
    ...
    // Hit parttern -----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kTC, 0, kHitPat, 0);
    const char* sub_name = "HitPat";
    // Add to the top directory
    for(Int_t i=0; i<NumOfPlaneParaTC; ++i){
      const char* title = NULL;
  ...
  //   Int_t target_id = getUniqueID(kTC, 0, kMulti, 0);
  //   const char* sub_name = "Multiplicity";
...
{
  // Determine the detector name
  TString strDet = CONV_STRING(kVC);
  // name list of crearted detector
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    // name list which are displayed in Ps tab
  ...
  // TDC-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kTDC2D  , 0);
    const char* sub_name = "TDC";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
  ...
  // TOT-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kTOT2D  , 0);
    const char* sub_name = "TOT";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
  ...
  // ADC-2D HighGain ----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kHighGain, 10);
    const char* sub_name = "HG";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
    ...
    // ADC-2D HighGain Cut ------------------------------------------
    target_id = getUniqueID(kVC, 0, kHighGain, 100);
    sub_name = "CHG";
    // Add to the top directory
    title = Form("%s_%s", nameDetector, sub_name);
    sub_dir->Add(createTH2(++target_id, title, // 1 origin
  ...
  // ADC-2D LowGain -----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kLowGain, 10);
    const char* sub_name = "LG";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
    ...
    // ADC-2D LowGain Cut ------------------------------------------
    target_id = getUniqueID(kVC, 0, kLowGain, 100);
    sub_name = "CLG";
    // Add to the top directory
    title = Form("%s_%s", nameDetector, sub_name);
    sub_dir->Add(createTH2(++target_id, title, // 1 origin
  ...
  // MultiHitTdc-2D -------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kMultiHitTdc, 20);
    const char* sub_name = "MultiHitTdc";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
  ...
  // ADC HighGain vs TOT ----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kHighGainvsTOT, 30);
    const char* sub_name = "HGvsTOT";
    // Add to the top directory
    TString strSubSubDir  = Form("%s_%s", nameDetector, sub_name);
    const char* nameSubSubDir = strSubSubDir.Data();
    ...
    // Hit parttern -----------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kHitPat, 0);
    const char* sub_name = "HitPat";
    // Add to the top directory
    const char* title = NULL;
    title = Form("%s_%s", nameDetector, sub_name);
  ...
  // Multiplicity -------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kVC, 0, kMulti, 0);
    const char* sub_name = "Multiplicity";

...
my_obj_rawhist_rc	:= $(core_obj) user_rawhist_rc.o $(gui_obj)
my_tgt_rawhist_rc	:= $(bin_dir)/raw_hist_rc

my_obj_rawhist_hbx	:= $(core_obj) user_rawhist_hbx.o $(gui_obj)
my_tgt_rawhist_hbx	:= $(bin_dir)/raw_hist_hbx

my_obj_rawhist_hbxx	:= $(core_obj) user_rawhist_hbxx.o $(gui_obj)
my_tgt_rawhist_hbxx	:= $(bin_dir)/raw_hist_hbxx
...
my_obj_rawhist_e63	:= $(core_obj) user_rawhist_e63.o $(gui_obj)
my_tgt_rawhist_e63	:= $(bin_dir)/raw_hist_e63
...
my_obj_jsroot_e63	:= $(core_obj) user_jsroot_e63.o
my_tgt_jsroot_e63	:= $(bin_dir)/jsroot_e63
...
my_obj_scaler_e63	:= $(core_obj) user_scaler_e63.o
my_tgt_scaler_e63	:= $(bin_dir)/scaler_e63
...
my_obj_ktune_e63      := $(core_obj) user_ktune_e63.o $(gui_obj)
my_tgt_ktune_e63      := $(bin_dir)/ktune_e63
...
#______________________________________________________________________________
my_obj_rawhist_rc	:= $(addprefix $(my_dir)/src/,$(my_obj_rawhist_rc))
my_obj_rawhist_rc	:= $(my_obj_rawhist_rc) \
		$(my_dir)/dict/GuiPs_Dict.o
my_lib_rawhist_rc	:= libmyrawhist_rc.so
$(eval $(call make-lib,$(my_lib_rawhist_rc),$(my_obj_rawhist_rc)))
$(eval $(call make-gui-target,$(my_tgt_rawhist_rc),$(my_lib_rawhist_rc)))
...
#______________________________________________________________________________
my_obj_rawhist_hbxx	:= $(addprefix $(my_dir)/src/,$(my_obj_rawhist_hbxx))
my_obj_rawhist_hbxx	:= $(my_obj_rawhist_hbxx) \
		$(my_dir)/dict/GuiPs_Dict.o
my_lib_rawhist_hbxx	:= libmyrawhist_hbx.so
$(eval $(call make-lib,$(my_lib_rawhist_hbxx),$(my_obj_rawhist_hbxx)))
$(eval $(call make-gui-target,$(my_tgt_rawhist_hbxx),$(my_lib_rawhist_hbxx)))
...
#______________________________________________________________________________
my_obj_rawhist_e63	:= $(addprefix $(my_dir)/src/,$(my_obj_rawhist_e63))
my_obj_rawhist_e63	:= $(my_obj_rawhist_e63) \
		$(my_dir)/dict/GuiPs_Dict.o
my_lib_rawhist_e63	:= libmyrawhist_e63.so
$(eval $(call make-lib,$(my_lib_rawhist_e63),$(my_obj_rawhist_e63)))
$(eval $(call make-gui-target,$(my_tgt_rawhist_e63),$(my_lib_rawhist_e63)))
#
#______________________________________________________________________________
...
#
#______________________________________________________________________________
my_obj_jsroot_e63 := $(addprefix $(my_dir)/src/,$(my_obj_jsroot_e63))
my_obj_jsroot_e63 := $(my_obj_jsroot_e63)
my_lib_jsroot_e63 := libmyjsroot_e63.so
$(eval $(call make-lib,$(my_lib_jsroot_e63),$(my_obj_jsroot_e63)))
$(eval $(call make-nogui-target,$(my_tgt_jsroot_e63),$(my_lib_jsroot_e63)))
#
#______________________________________________________________________________
...
#______________________________________________________________________________
my_obj_scaler_e63 := $(addprefix $(my_dir)/src/,$(my_obj_scaler_e63))
my_lib_scaler_e63 := libmyscaler_e63.so
$(eval $(call make-lib,$(my_lib_scaler_e63),$(my_obj_scaler_e63)))
$(eval $(call make-nogui-target,$(my_tgt_scaler_e63),$(my_lib_scaler_e63)))
...
#______________________________________________________________________________
my_obj_ktune_e63      := $(addprefix $(my_dir)/src/,$(my_obj_ktune_e63))
my_obj_ktune_e63      := $(my_obj_ktune_e63) \
		        $(my_dir)/dict/GuiPs_Dict.o
my_lib_ktune_e63      := libmyktune_e63.so
$(eval $(call make-lib,$(my_lib_ktune_e63),$(my_obj_ktune_e63)))
$(eval $(call make-gui-target,$(my_tgt_ktune_e63),$(my_lib_ktune_e63)))
